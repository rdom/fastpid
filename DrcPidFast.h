...
class DrcPidFast {
 ...
 public:
  ...
  // thickness   thickness of the radiator (10 mm or 17 mm)
  DrcPidInfo GetInfo(int pdg, TVector3 mom, double track_err = 0, int thickness = 17);

  // p - momentum of the particle [GeV/c]
  // theta - polar angle of the particle [deg]
  DrcPidInfo GetInfo(int pdg, double p, double theta, double track_err = 0, int thickness = 17);
 ...
 private:
  ...
  TH2F *fTrrMap;
  double fMass[5];
  TF1 *fMs_mom, *fMs_thickness_10, *fMs_thickness_17;
